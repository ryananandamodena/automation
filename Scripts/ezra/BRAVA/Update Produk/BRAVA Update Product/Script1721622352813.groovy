...
WebUI.rightClick(findTestObject('Object Repository/BRAVA/Page_Part - CSMS/a_Create'))

WebUI.click(findTestObject('Object Repository/BRAVA/Page_Home - CSMS/a_Create Part Number'))

WebUI.click(findTestObject('Object Repository/BRAVA/Page_Part - CSMS/td_CBZ-AD-DOR-0002-0118'))

WebUI.click(findTestObject('Object Repository/BRAVA/Page_Part - CSMS/a_Secondary Data Skow'))

WebUI.setText(findTestObject('Object Repository/BRAVA/Page_Part - CSMS/textarea_Description_description'), 'test description')

WebUI.click(findTestObject('Object Repository/BRAVA/Page_Part - CSMS/button_Update'))
