...
WebUI.setText(findTestObject('B2B/Brand/Page_B2B Portal/Data_search'), 'PCS1')
...
WebUI.verifyElementText(findTestObject('B2B/unit/Page_B2B Portal/p_Your search did not match any datas. Please try again or create a new one'), 
