...
WebUI.click(findTestObject('Object Repository/gccs/sprint 8/Page_Cost - GCCS/svg'))

WebUI.setText(findTestObject('Object Repository/gccs/sprint 8/Page_Cost - GCCS/input_Labor Cost_laborCostModal'), '100')

WebUI.setText(findTestObject('Object Repository/gccs/sprint 8/Page_Cost - GCCS/input_Material Cost_materialCostModal'), 
    '100')

WebUI.click(findTestObject('Object Repository/gccs/sprint 8/Page_Cost - GCCS/button_Update'))
