...
//WebUI.click(findTestObject('gccs/gccs_sprint_7/Page_ETA - GCCS/div_21'))
...
WebUI.setText(findTestObject('Object Repository/gccs/gccs_sprint_7/Page_ETA - GCCS/textarea_test'), '')

WebUI.verifyElementText(findTestObject('Object Repository/gccs/gccs_sprint_7/Page_ETA - GCCS/button_Save'), '')
