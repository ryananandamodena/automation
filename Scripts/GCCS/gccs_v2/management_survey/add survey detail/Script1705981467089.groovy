...
WebUI.click(findTestObject('Object Repository/gccs/gccs_surveymanagement/survey management/Page_Survey Management - GCCS/span_Detail'))

WebUI.delay(2)

WebUI.click(findTestObject('Object Repository/gccs/gccs_surveymanagement/survey management/Page_Edit Survey Management - GCCS/button_Add choise'))
