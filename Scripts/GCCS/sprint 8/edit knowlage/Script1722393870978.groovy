...
WebUI.click(findTestObject('Object Repository/gccs/sprint 8/Page_Knowledge - GCCS/div_Edit'))
...
WebUI.click(findTestObject('Object Repository/gccs/sprint 8/Page_Knowledge - GCCS/span_nagabonar33'))
