...
WebUI.setText(findTestObject('Object Repository/gccs/sprint 8/Page_Login - GCCS/input_Username_userName'), 'sa_cc')
...
WebUI.click(findTestObject('Object Repository/gccs/sprint 8/Page_Service Area - GCCS/div_Edit'))

WebUI.click(findTestObject('Object Repository/gccs/sprint 8/Page_Service Area - GCCS/span_DSC'))

WebUI.click(findTestObject('Object Repository/gccs/sprint 8/Page_Service Area - GCCS/li_ASC'))

WebUI.click(findTestObject('Object Repository/gccs/sprint 8/Page_Service Area - GCCS/span_AP'))

WebUI.click(findTestObject('Object Repository/gccs/sprint 8/Page_Service Area - GCCS/li_AR'))
