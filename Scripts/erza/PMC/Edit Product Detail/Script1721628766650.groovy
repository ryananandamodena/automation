...
WebUI.click(findTestObject('Object Repository/PMC/Edit Product Detail/td_test'))

WebUI.click(findTestObject('Object Repository/PMC/Edit Product Detail/button_Edit Product'))

WebUI.setText(findTestObject('Object Repository/PMC/Edit Product Detail/input_Scale_scale'), 'testtest')

WebUI.click(findTestObject('Object Repository/PMC/Edit Product Detail/i_Save_fa fa-save'))
