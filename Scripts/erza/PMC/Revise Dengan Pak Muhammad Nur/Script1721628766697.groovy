...
WebUI.click(findTestObject('PMC/Revise With Muhamad Nur/span_View honda civic'))

WebUI.scrollToElement(findTestObject('PMC/Approve With Muhamad Nur/button_Revise'), 0)

WebUI.click(findTestObject('PMC/Approve With Muhamad Nur/button_Revise'))
