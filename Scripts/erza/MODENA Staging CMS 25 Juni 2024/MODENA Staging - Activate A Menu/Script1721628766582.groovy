...
WebUI.scrollToElement(findTestObject('CMS/i_testete_fi fi-rr-menu-dots-vertical'), 10000)

WebUI.click(findTestObject('CMS/i_testete_fi fi-rr-menu-dots-vertical'))

WebUI.click(findTestObject('CMS/button_Active with attribute'))
