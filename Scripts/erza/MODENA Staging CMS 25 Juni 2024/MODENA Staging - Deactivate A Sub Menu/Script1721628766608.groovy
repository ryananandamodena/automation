...
WebUI.click(findTestObject('CMS/span_Corporate_fi fi-rr-angle-small-down'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('CMS/Page_MODENA/i_Corporasi Nihonggo_fi fi-rr-menu-dots-vertical'))

WebUI.click(findTestObject('CMS/button_Deactive'))
