...
WebUI.scrollToElement(findTestObject('CMS/i_Corporate_fi fi-rr-menu-dots-vertical'), 0)

WebUI.click(findTestObject('CMS/i_Corporate_fi fi-rr-menu-dots-vertical'))
