...
WebUI.click(findTestObject('Object Repository/BRAVA/Page_Part - CSMS/a_E-catalog'))

WebUI.rightClick(findTestObject('Object Repository/BRAVA/Page_Part - CSMS/a_Create'))

WebUI.click(findTestObject('Object Repository/BRAVA/Page_Part - CSMS/a_Create Part Number'))
