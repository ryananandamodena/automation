...
WebUI.setText(findTestObject('Object Repository/MCI Page/MCI order/Page_More 2.0/input_Email or Username_username'), Username)

WebUI.setEncryptedText(findTestObject('Object Repository/MCI Page/MCI order/Page_More 2.0/input_Password_password'), Password)
