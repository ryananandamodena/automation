...
WebUI.click(findTestObject('more/Page_More 2.0/p_MODENA Indonesia (MODENA_LIVE)'))

WebUI.click(findTestObject('more/Page_More 2.0/Campaign Management'))

WebUI.click(findTestObject('more/Page_More 2.0/a_Campaign'))

WebUI.click(findTestObject('more/Page_More 2.0/button_Add Campaign'))

WebUI.setText(findTestObject('Object Repository/more/Page_More 2.0/input__campaign_name'), 'test diskon 45%')
...
WebUI.setText(findTestObject('Object Repository/more/Page_More 2.0/textarea__remarks'), 'test diskon 45%')
...
WebUI.click(findTestObject('more/Page_More 2.0/Page_More 2.0/div_Upload File'))

WebUI.delay(3)

WebUI.uploadFile(findTestObject('more/Page_More 2.0/Page_More 2.0/img'), 'C:\\Users\\ryan.ananda\\Downloads\\VOC (6).xlsx')
